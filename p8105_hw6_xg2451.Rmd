...
The violin plot illustrates the RMSE distributions for the three models. The proposed model (my_model) demonstrates the lowest RMSE (mean = 275.96), outperforming both the simpler model (model_1, mean = 335.45) and the interaction-heavy model (model_2, mean = 290.67).
